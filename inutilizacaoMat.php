...
<div class="container justify-content-center mt-5 mb-5 bg-white p-3 col-11 rounded shadow w-75">
  ...
  <form name= "form" class="needs-validation justify-content-center" role="form" action="./app/inutilizacaoMatbd.php" method="POST">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control"  id = "idAlmoxLogin" name="idAlmoxLogin"  value="<?=$_SESSION["idAlmoxLogin"];?>" >
    </div>
    ...
    <div class="form-group" >
      ...
      <input type="text" class="form-control" id="qtdEmEstoque" name="qtdEmEstoque" value="<?=$linha['qtd_estoque_prod'];?>" onfocus="calcular()"> 
    </div>

    <!-- vl. preco medio / vl. total material-->
    <div class="d-flex" style="gap: 16px;">
      <div class="form-group w-50" >
        <label for="vlUnit" class="control-loteMaterial">Vl. Preço Médio:</label>
        <input type="text" class="form-control" id="vlUnit" name="vlUnit" value="<?=$linha['vl_preco_med_prod'];?>" onblur="calcular()"> 
      </div> 

      <div class="form-group w-50">
        <label for="vlTotalMaterial" class="control-loteMaterial">Vl. Total Material:</label>
        <input type="text" class="form-control" id="vlTotalMaterial" name="vlTotalMaterial" value="<?=$linha['vl_preco_total_prod'];?>"> 
      </div> 
    </div>
