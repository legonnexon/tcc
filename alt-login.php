...
<input type="hidden" name="id" value="<?=$linha['idLogin'];?>">
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" name="nomeLogin" id="nomeLogin" placeholder="Insira seu nome" required="required" value="<?=$linha['nomeLogin'];?>">
   ...
   <div class="form-group">
    ...
    <input type="text" class="form-control" name="usuarioLogin" id="usuarioLogin" placeholder="Altere seu login" required="required" value="<?=$linha['usuarioLogin'];?>">
    <div class="valid-feedback">
      Parece bom!
    </div>
    <div class="invalid-feedback">
  ...
  <div class="form-group">
    ...
    <input type="email" class="form-control" name="emailLogin" id="emailLogin" placeholder="Altere seu login" required="required" value="<?=$linha['emailLogin'];?>">
    <div class="valid-feedback">
      Parece bom!
    </div>
    <div class="invalid-feedback">
