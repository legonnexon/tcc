...
$stats       = filter_input(INPUT_POST, "statusLogin", FILTER_SANITIZE_STRING);
...
try { // O que deve ser feito.
  ...
  $comandoSQL = $conexao->prepare("INSERT INTO c_usuario (nomeLogin, usuarioLogin, 
       nivelLogin, emailLogin, senhaLogin, dataLogin, idAlmoxLogin_FK, statusLogin)

        VALUES (:nome, :login, :nivel, :email, :senha, :data, :almoxLogin, :stats)");
