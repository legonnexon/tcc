...
$comandoSQLTotalitens = "SELECT * FROM c_item_em  WHERE id_capaem= $id and  id_item_em = $idMaterial ";
$resultadoTotalItem = $conexao->query($comandoSQLTotalitens);
$linhaTotalItem = $resultadoTotalItem->fetch(PDO::FETCH_ASSOC);
     
            
        
       $comandoValidaMaterialSQL02 =("SELECT * FROM c_produto where lote_prod like '%".$loteMaterial."%' ");
      ...
      if($linha == ''  )
      {
          ...
          $comandoMatSQL = $conexao->prepare(
            ...
            (	
             ...
             :dataFab, :dataValid, :idAlmoxLogin
             )"
