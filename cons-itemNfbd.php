...
try {
    ...
    $comandoSQL = "SELECT 
				     ...
				     total_itens_nota,
				     (capaNf.vl_conferencia - total_itens_nota) as diferenca
				     
				     FROM c_capa_em capaNf
				     inner join ( SELECT sum(itNF.vl_total_ite) as total_itens_nota,  Nf.id_capaem as id_capa
				                                                   FROM c_capa_em NF 
				                ...
				                where total_itens_nota < capaNf.vl_conferencia or total_itens_nota > capaNf.vl_conferencia
